            ...
            {loading ? (
              ...
              <div className='font-inter ml-2'>
                <div className='space-y-2 md:space-y-2 text-left'>
                  ...
                  <p className='text-naranja text-sm mt-1'>NOTA: Si necesitas editar el nombre, documento o rol por favor comunicarte con el administrador</p>
                </div>
              </div>
            ) : (
